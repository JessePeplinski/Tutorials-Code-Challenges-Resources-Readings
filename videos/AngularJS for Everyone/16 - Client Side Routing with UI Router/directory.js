	   ...
	   .config(function($stateProvider, $urlRouterProvider) {
		...
		$stateProvider
			.state('home', {
				...
				template: '<h1>Hello</h1>' // template URL property, reference another template. can also just use html
			})

			.state('about', {
				url: '/about', // localhost/#/about
				template: '<h1>About</h1>' // template URL property, reference another template. can also just use html
			});
	})
