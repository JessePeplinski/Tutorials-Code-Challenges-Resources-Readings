	   ...
	   .config(function($stateProvider, $urlRouterProvider) {
		...
		$stateProvider
			.state('home', {
				...
				templateUrl: 'home.html' // Change to templateUrl to render a file
			})

			.state('about', {
				url: '/about', // localhost/#/about
				templateUrl: 'about.html' // template URL property, reference another template. can also just use html
			});
	})
